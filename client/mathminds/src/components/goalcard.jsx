...
const WeeklyGoalCard = ({ completedExercises, weeklyGoal }) => {
    const progress = (completedExercises / weeklyGoal) * 100;

    return (
        <div className="bg-white p-6 rounded-md shadow-lg dark:bg-gray-700 mb-6">
            <div className="flex items-center justify-end mb-4">
                <div className="w-60 h-4 bg-red-200 rounded-full overflow-hidden">
